...
exports.getList = (req, res) => {
    ...
    res.render("gallery/list.html", { boardList: reversedList });
}
...
exports.getView = (req, res)=>{
    ...
    if (index < 0 || index >= boardList.length) {
      // 에러 방지용 빈 페이지 띄우기
      return res.render("gallery/view.html", { boardItem: {} });
    }
    const boardItem = boardList[index];
    boardItem.hit += 1;
    res.render("gallery/view.html", { boardItem, boardList });
}
...
exports.getModify = (req, res) =>{
    ...
    res.render("gallery/modify.html", { boardItem, index });
}

exports.postList = (req, res)=>{
    res.redirect("/board/gallery/list");
}
...
exports.postWrite = (req,res)=>{
    ...
    res.redirect(`/board/gallery/view?index=${boardItem.idx}`);
}
...
exports.postModify = (req, res) =>{
    ...
    res.redirect("/board/gallery/view?index=" + index);
}
